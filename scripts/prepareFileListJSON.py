...
from L1Trigger.anomalyTriggerSkunkworks.dasInterface import dasInterface
import json
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataTier',nargs = '?', choices=['MINIAODSIM','NANOAODSIM','MINIAOD','NANOAOD','RAW'],help='Datatier to form the list of files for',default='MINIAODSIM')
