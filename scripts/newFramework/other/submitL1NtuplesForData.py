...
parser = argparse.ArgumentParser(description='submit the l1 ntuple configuration for data')
parser.add_argument(
    '--fileList',
    '-f',
    required=True,
...
config=f'{os.environ["CMSSW_BASE"]}/src/anomalyDetection/anomalyTriggerSkunkworks/python/newFrameworkNtuplization/l1NtupleFromDataSkim.py'
