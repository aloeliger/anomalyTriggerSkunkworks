...
def makeRunPlot(run, theFile, destinationPath, CICADAVersion):
    ...
    smooth_overall0p5kHZPlot.Draw("HIST")
    smooth_overall0p5kHZPlot.GetXaxis().SetTitle("Lumi")
    smooth_overall0p5kHZPlot.GetYaxis().SetTitle("Rate (kHz)")
    smooth_overall0p5kHZPlot.GetYaxis().SetRangeUser(0.1, 100)
    smooth_overall0p5kHZPlot.SetTitle('')

    smooth_overall1kHZPlot.Draw("HIST SAME")
    smooth_overall2kHZPlot.Draw("HIST SAME")
    smooth_overall3kHZPlot.Draw("HIST SAME")
    smooth_overall5kHZPlot.Draw("HIST SAME")
