...
static constexpr auto s_tag = "[anomalyTriggerSkunkworks]";

TEST_CASE("Standard checks of anomalyTriggerSkunkworks", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("anomalyTriggerSkunkworks"
