...
L1TCaloSummaryTestNtuplizer = cms.EDAnalyzer('L1TCaloSummaryTestNtuplizer',
                                             ...
                                             bitAccurateScoreSource = cms.InputTag("uct2016EmulatorDigis:bitAccurateAnomalyScore"),
                                             precompiledModelScoreSource = cms.InputTag("uct2016EmulatorDigis:precompiledModelAnomalyScore"),
