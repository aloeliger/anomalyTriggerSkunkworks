...
config.General.requestName = f'CICADA_EphemeralZeroBias7_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias7/Run2018D-PromptReco-v2/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias7/Run2018D-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_EphemeralZeroBias71_{todaysDate}'
