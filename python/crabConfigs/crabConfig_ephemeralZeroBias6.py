...
config.General.requestName = f'CICADA_EphemeralZeroBias6_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias6/Run2018D-PromptReco-v2/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias6/Run2018D-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_EphemeralZeroBias6_{todaysDate}'
