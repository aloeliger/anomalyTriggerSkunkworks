...
config.General.requestName = f'CICADA_EphemeralZeroBias5_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias5/Run2018D-PromptReco-v2/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias5/Run2018D-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_EphemeralZeroBias5_{todaysDate}'
