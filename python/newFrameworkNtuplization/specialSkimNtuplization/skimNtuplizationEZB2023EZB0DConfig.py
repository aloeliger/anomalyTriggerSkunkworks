...
config.General.requestName = f'CICADASkimNtuplization_2023RunD_EZB0_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias0/Run2023D-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias0/Run2023D-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADASkimNtuplization_2023RunD_EZB0_{todaysDate}'
