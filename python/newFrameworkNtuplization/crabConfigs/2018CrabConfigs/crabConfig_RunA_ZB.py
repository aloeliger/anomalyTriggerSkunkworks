...
config.General.requestName = f'CICADA_2018RunA_ZB_{todaysDate}'
...
config.Data.secondaryInputDataset = '/ZeroBias/Run2018A-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2018RunA_ZB_{todaysDate}'
