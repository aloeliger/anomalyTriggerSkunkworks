...
config.General.requestName = f'CICADA_2022RunC_ZB_{todaysDate}'
...
config.Data.inputDataset = '/ZeroBias/Run2022C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/ZeroBias/Run2022C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022RunC_ZeroBias_{todaysDate}'
