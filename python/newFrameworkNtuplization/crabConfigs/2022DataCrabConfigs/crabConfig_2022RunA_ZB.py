...
config.General.requestName = f'CICADA_2022RunA_ZB_{todaysDate}'
...
config.Data.inputDataset = '/ZeroBias/Run2022A-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/ZeroBias/Run2022A-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022RunA_ZeroBias_{todaysDate}'
