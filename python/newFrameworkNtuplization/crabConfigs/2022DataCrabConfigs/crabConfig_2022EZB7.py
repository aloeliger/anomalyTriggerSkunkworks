...
config.General.requestName = f'CICADA_2022EZB7_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias7/Run2022G-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias7/Run2022G-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022EphemeralZeroBias7_{todaysDate}'
