...
config.General.requestName = f'CICADA_2022EZB6_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias6/Run2022G-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias6/Run2022G-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022EphemeralZeroBias6_{todaysDate}'
