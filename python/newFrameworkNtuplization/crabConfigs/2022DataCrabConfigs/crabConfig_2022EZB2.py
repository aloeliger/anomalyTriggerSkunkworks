...
config.General.requestName = f'CICADA_2022EZB2_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias2/Run2022G-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias2/Run2022G-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022EphemeralZeroBias2_{todaysDate}'
