...
config.General.requestName = f'CICADA_2022RunE_ZB_{todaysDate}'
...
config.Data.inputDataset = '/ZeroBias/Run2022E-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/ZeroBias/Run2022E-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022RunE_ZeroBias_{todaysDate}'
