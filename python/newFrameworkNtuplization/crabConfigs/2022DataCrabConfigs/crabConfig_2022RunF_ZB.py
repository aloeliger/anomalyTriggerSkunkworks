...
config.General.requestName = f'CICADA_2022RunF_ZB_{todaysDate}'
...
config.Data.inputDataset = '/ZeroBias/Run2022F-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/ZeroBias/Run2022F-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022RunF_ZeroBias_{todaysDate}'
