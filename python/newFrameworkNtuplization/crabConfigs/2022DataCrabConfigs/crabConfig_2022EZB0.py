...
config.General.requestName = f'CICADA_2022EZB0_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias0/Run2022G-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias0/Run2022G-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022EphemeralZeroBias0_{todaysDate}'
