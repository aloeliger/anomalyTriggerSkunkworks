...
config.General.requestName = f'CICADA_2022RunB_ZB_{todaysDate}'
...
config.Data.inputDataset = '/ZeroBias/Run2022B-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/ZeroBias/Run2022B-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022RunB_ZeroBias_{todaysDate}'
