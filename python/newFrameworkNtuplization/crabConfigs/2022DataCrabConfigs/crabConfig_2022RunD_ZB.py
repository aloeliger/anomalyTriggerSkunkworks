...
config.General.requestName = f'CICADA_2022RunD_ZB_{todaysDate}'
...
config.Data.inputDataset = '/ZeroBias/Run2022D-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/ZeroBias/Run2022D-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022RunD_ZeroBias_{todaysDate}'
