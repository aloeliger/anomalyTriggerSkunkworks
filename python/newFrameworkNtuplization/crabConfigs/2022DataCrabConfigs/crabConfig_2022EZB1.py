...
config.General.requestName = f'CICADA_2022EZB1_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias1/Run2022G-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias1/Run2022G-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022EphemeralZeroBias1_{todaysDate}'
