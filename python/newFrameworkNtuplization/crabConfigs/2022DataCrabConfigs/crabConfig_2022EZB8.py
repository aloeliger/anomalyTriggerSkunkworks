...
config.General.requestName = f'CICADA_2022EZB8_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias8/Run2022G-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias8/Run2022G-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022EphemeralZeroBias8_{todaysDate}'
