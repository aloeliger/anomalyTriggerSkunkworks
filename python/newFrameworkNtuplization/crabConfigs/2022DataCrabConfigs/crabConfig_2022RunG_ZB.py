...
config.General.requestName = f'CICADA_2022RunG_ZB_{todaysDate}'
...
config.Data.secondaryInputDataset = '/ZeroBias/Run2022G-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022RunG_ZeroBias_{todaysDate}'
