...
config.General.requestName = f'CICADA_2022EZB3_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias3/Run2022G-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias3/Run2022G-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022EphemeralZeroBias3_{todaysDate}'
