...
config.General.requestName = f'CICADA_2022EZB4_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias4/Run2022G-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias4/Run2022G-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022EphemeralZeroBias4_{todaysDate}'
