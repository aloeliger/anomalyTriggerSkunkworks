...
config.General.requestName = f'CICADA_2023EZB14_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias14/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias14/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias14_{todaysDate}'
