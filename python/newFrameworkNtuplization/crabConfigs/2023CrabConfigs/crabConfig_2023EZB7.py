...
config.General.requestName = f'CICADA_2023EZB7_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias7/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias7/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias7_{todaysDate}'
