...
config.General.requestName = f'CICADA_2023EZB12_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias12/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias12/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias12_{todaysDate}'
