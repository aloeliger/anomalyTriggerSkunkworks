...
config.General.requestName = f'CICADA_2023EZB4_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias4/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias4/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias4_{todaysDate}'
