...
config.General.requestName = f'CICADA_2023EZB9_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias9/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias9/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias9_{todaysDate}'
