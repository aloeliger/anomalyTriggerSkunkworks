...
config.General.requestName = f'CICADA_2023EZB5_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias5/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias5/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias5_{todaysDate}'
