...
config.General.requestName = f'CICADA_2023EZB2_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias2/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias2/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias2_{todaysDate}'
