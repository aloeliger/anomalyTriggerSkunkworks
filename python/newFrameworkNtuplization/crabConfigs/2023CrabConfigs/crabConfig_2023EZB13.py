...
config.General.requestName = f'CICADA_2023EZB13_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias13/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias13/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias13_{todaysDate}'
