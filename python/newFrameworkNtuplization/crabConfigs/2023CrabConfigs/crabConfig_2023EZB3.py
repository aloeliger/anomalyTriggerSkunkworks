...
config.General.requestName = f'CICADA_2023EZB3_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias3/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias3/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias3_{todaysDate}'
