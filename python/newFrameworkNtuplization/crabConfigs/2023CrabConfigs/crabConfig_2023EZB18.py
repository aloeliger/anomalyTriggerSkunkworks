...
config.General.requestName = f'CICADA_2023EZB18_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias18/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias18/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias18_{todaysDate}'
