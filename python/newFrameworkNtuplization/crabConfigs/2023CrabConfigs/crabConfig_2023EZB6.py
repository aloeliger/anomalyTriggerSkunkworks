...
config.General.requestName = f'CICADA_2023EZB6_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias6/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias6/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias6_{todaysDate}'
