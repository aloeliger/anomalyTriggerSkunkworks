...
config.General.requestName = f'CICADA_2023EZB10_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias10/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias10/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias10_{todaysDate}'
