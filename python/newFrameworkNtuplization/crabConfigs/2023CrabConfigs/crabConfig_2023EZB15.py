...
config.General.requestName = f'CICADA_2023EZB15_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias15/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias15/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias15_{todaysDate}'
