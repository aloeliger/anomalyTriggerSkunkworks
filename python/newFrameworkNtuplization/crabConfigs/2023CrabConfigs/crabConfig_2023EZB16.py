...
config.General.requestName = f'CICADA_2023EZB16_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias16/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias16/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias16_{todaysDate}'
