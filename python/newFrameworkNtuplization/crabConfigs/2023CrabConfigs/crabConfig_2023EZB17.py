...
config.General.requestName = f'CICADA_2023EZB17_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias17/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias17/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias17_{todaysDate}'
