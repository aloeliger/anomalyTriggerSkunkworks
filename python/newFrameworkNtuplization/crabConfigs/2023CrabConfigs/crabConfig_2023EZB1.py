...
config.General.requestName = f'CICADA_2023EZB1_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias1/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias1/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias1_{todaysDate}'
