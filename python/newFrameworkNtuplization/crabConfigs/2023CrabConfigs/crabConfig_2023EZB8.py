...
config.General.requestName = f'CICADA_2023EZB8_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias8/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias8/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias8_{todaysDate}'
