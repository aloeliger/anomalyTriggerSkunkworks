...
config.General.requestName = f'CICADA_2023EZB19_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias19/Run2023C-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias19/Run2023C-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADA_2023EphemeralZeroBias19_{todaysDate}'
