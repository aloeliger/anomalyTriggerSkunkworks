...
config.General.requestName = f'CICADA_2022_DYto2L_{todaysDate}'
...
config.Data.secondaryInputDataset = '/DYTo2L_MLL-50_TuneCP5_13p6TeV_pythia8/Run3Summer22DRPremix-124X_mcRun3_2022_realistic_v12-v2/GEN-SIM-RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022_DYto2L_{todaysDate}'
