...
config.General.requestName = f'CICADA_2022_ggHTT_{todaysDate}'
...
config.Data.inputDataset = '/GluGluHToTauTau_M-125_TuneCP5_13p6TeV_powheg-pythia8/Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12-v3/MINIAODSIM'
config.Data.secondaryInputDataset = '/GluGluHToTauTau_M-125_TuneCP5_13p6TeV_powheg-pythia8/Run3Summer22DRPremix-124X_mcRun3_2022_realistic_v12-v3/GEN-SIM-RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022_ggHTT_{todaysDate}'
