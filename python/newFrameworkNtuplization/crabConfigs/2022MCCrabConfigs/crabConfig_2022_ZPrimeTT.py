...
config.General.requestName = f'CICADA_2022_ZPrimeTT_{todaysDate}'
...
config.Data.inputDataset = '/ZprimeToTauTau_M-4000_TuneCP5_tauola_13p6TeV-_pythia8/Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12-v2/MINIAODSIM'
config.Data.secondaryInputDataset = '/ZprimeToTauTau_M-4000_TuneCP5_tauola_13p6TeV-_pythia8/Run3Summer22DRPremix-124X_mcRun3_2022_realistic_v12-v2/GEN-SIM-RAW'
...
config.Data.outputDatasetTag = f'CICADA_2022_ZPrimeTT_{todaysDate}'
