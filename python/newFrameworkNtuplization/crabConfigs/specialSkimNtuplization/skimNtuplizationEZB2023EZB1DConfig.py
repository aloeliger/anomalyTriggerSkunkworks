...
config.General.requestName = f'CICADASkimNtuplization_2023RunD_EZB1_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias1/Run2023D-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias1/Run2023D-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADASkimNtuplization_2023RunD_EZB1_{todaysDate}'
