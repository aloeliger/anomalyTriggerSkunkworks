...
config.General.requestName = f'CICADASkimNtuplization_2023RunA_ZB_{todaysDate}'
...
config.Data.outputDatasetTag = f'CICADASkimNtuplization_2023RunA_ZB_{todaysDate}'
