...
config.General.requestName = f'CICADASkimNtuplization_2023RunB_ZB_{todaysDate}'
...
config.Data.inputDataset = '/ZeroBias/Run2023B-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/ZeroBias/Run2023B-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADASkimNtuplization_2023RunB_ZB_{todaysDate}'
