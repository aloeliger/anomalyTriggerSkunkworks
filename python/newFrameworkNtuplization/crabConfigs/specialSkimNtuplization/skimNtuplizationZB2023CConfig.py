...
config.General.requestName = f'CICADASkimNtuplization_2023RunC_ZB_{todaysDate}'
...
config.Data.outputDatasetTag = f'CICADASkimNtuplization_2023RunC_ZB_{todaysDate}'
