...
config.General.requestName = f'CICADASkimNtuplization_2023RunD_EZB2_{todaysDate}'
...
config.Data.inputDataset = '/EphemeralZeroBias2/Run2023D-PromptReco-v1/MINIAOD'
config.Data.secondaryInputDataset = '/EphemeralZeroBias2/Run2023D-v1/RAW'
...
config.Data.outputDatasetTag = f'CICADASkimNtuplization_2023RunD_EZB2_{todaysDate}'
